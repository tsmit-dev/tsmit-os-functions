      ...
      export const registerUser = async (data: UserData, password: string): Promise<{uid: string}> => {
        try {
      ...
      export const deleteUser = async (id: string): Promise<boolean> => {
        ...
        console.error("A função deleteUser foi desativada por razões de segurança e precisa ser migrada para uma Cloud Function.");
        throw new Error("A exclusão de usuários a partir do cliente foi desativada. Contacte o administrador.");
      };
